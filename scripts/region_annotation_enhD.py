...
def process_regions(region_file, annotation_file, gene_bed_file, ccre_file):
    """
...
if __name__=='__main__':
   ...
   # Process data
   exon_genes, intro_genes, prom_genes, enhP_genes, enhD_genes = process_regions(region_file, annotation_file, sys.argv[3], sys.argv[4])
